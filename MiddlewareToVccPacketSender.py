...
class MiddlewareToVccPacket:
    ...
    def toBuffer(self):
        ...
        self.wea_visibiran)
    def fromBuffer(self):
        self.result = struct.unpack('=1B8f2d14f', self.toBuffer())
        print(self.result[0]) #mode
        print(self.result[9]) #nav_longitude
        print(self.result[10]) # nav_latitude
        print(self.result[24]) # wea_visibiran
